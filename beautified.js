...
window.jwplayer = (function (t) {
                                    ...
                                    if (u) {
                                        ...
                                        if (e || n)
                                            for (var c = 0, s = u.length; c < s; c++) {
                                                var l = u[c];
                                                ((e && e !== l.callback && e !== l.callback._callback) ||
                                                    (n && n !== l.context)) &&
                                                    a.push(l);
                                            }
    ...
    function (t, e, n) {
        ...
        function c(t) {
            var e = null;
            try {
                (a((e = new window.DOMParser().parseFromString(t, "text/xml")).childNodes) ||
                    (e.childNodes && a(e.childNodes[0].childNodes))) &&
                    (e = null);
            } catch (t) {}
            return e;
        }
                ...
                supports: function (t) {
                    ...
                    return (
                        ...
                        (!Object(a.isRtmp)(t.file, e) &&
                            ["flv", "f4v", "mov", "m4a", "m4v", "mp4", "aac", "f4a", "mp3", "mpeg", "smil"].indexOf(e) >
                                -1)
                    );
                },
            }),
            ...
            return "" === e || null == e
                ...
                : "string" == typeof e && isNaN(e)
                  ...
                  : 0 === e || "z-index" === t || "opacity" === t
                    ? "" + e
                    : /color/i.test(t)
                      ? "#" + Object(r.d)(e.toString(16).replace(/^0x/i, ""), 6)
                      : Math.ceil(e) + "px";
        }
        function p(t, e) {
                ...
                C = (function (t, e) {
                    return function (t, n) {
                        ...
                        if ((clearTimeout(e.timeoutId), e.retryWithoutCredentials && e.xhr.withCredentials)) {
                            ...
                            !n && i.status >= 400 && i.status < 600 && (n = i.status), j(e, n ? u.o : u.r, n || d, t);
                    };
                })(0, k);
    ...
    function (t, e, n) {
        ...
        var r =
            "8.8.2+commercial_v8-8-2.315.commercial.2c5034e.hlsjs..jwplayer.a810fff.dai.45542e3.freewheel.9422044.googima.fd7c6e3.vast.dbafd7d.analytics.c46577e.gapro.8d11024";
    },
    function (t, e, n) {
        "use strict";
        var r = n(0),
                        ...
                        if ((clearTimeout(h), t.el))
                            if ((M(t), N(t, y), t.dragged)) (t.dragged = !1), L(t, i.t, n);
                                ...
                                !(function (t, e, n) {
                                    ...
                                    o ? L(t, i.n, n) : (L(t, i.sb, n), "touchend" !== n.type || w || D(n));
                            }
                    };
                b
                    ? F(t, "init", "pointerdown", o, r)
                    : (m && F(t, "init", "mousedown", o, r), F(t, "init", "touchstart", o, r)),
                ...
                for (var s = 0; s < Object(r.c)(e); s++) {
                    ...
                    if ("media" === l.prefix) {
                        ...
                        switch (Object(r.b)(l).toLowerCase()) {
                            case "content":
                                if (
                                    (Object(i.i)(l, "duration") &&
                                        (n.duration = Object(i.f)(Object(i.i)(l, "duration"))),
                                    Object(i.i)(l, "url"))
                                ) {
                                    n.sources || (n.sources = []);
                                    var f = {
                ...
                getNewInstance: function (t, e, n) {
                    ...
                    return (
                        (i.addToPlayer = function () {
                            ...
                            e &&
                                ((n.left = e.style.left), (n.top = e.style.top), e.appendChild(n), (i.displayArea = e));
                        }),
    ...
    function (t, e, n) {
        ...
        var d = function (t, e) {
                ...
                (!h.playbackRateControls || h.playbackRates.indexOf(h.defaultPlaybackRate) < 0) &&
                ...
                return (
                    (h.bandwidthEstimate = Object(r.z)(k)
                        ? k
                    ...
                    (h.backgroundLoading = Object(r.r)(h.backgroundLoading)
                        ? h.backgroundLoading
        ...
        var O = function (t, e) {
                ...
                if (
                    ((u.flashplayer = (function (t) {
                        var e = t.flashplayer;
                        return (
                            e || (e = (Object(o.getScriptPath)("jwplayer.js") || t.base) + "jwplayer.flash.swf"),
        ...
        function B(t) {
            ...
            if (n && n.code === p.a) {
                ...
                if (i > 0 && i < 4 && r && o.duration() > -7776e6)
                    return new T.a("//content.jwplatform.com/libraries/".concat(r, ".js"))
                        .load()
                        .then(function () {
                                ...
                                (function (t, e, n) {
                                    Promise.resolve().then(function () {
                                        ...
                                        if (!o) {
                                            ...
                                            Z.a.cloneIcon &&
                                                u.querySelector(".jw-icon").appendChild(Z.a.cloneIcon("error")),
                                                ct(t, u);
                                        }
                                        i.set("errorEvent", r),
                                            i.set("state", P.mb),
    ...
    function (t, e, n) {
        ...
        function i(t) {
            return "hls" === t.type && r.OS.android
                ? !1 !== t.androidhls && !r.Browser.firefox && parseFloat(r.OS.version.version) >= 4.4
                : null;
        }
    },
    function (t, e, n) {
        ...
        var D = Object(r.j)({}, E, T, h, {
                ...
                crossdomain: function (t) {
                    ...
                    try {
                        return (
                            (n.href = t), (n.href = n.href), e.protocol + "//" + e.host != n.protocol + "//" + n.host
                        );
                    } catch (t) {}
                    return !0;
                },
            ...
            if (
                (t
                    ? "string" == typeof t
                        ...
                        : "number" == typeof t
                          ? (e = v.a[t])
                          : t.nodeType && (e = X((n = t).id || n.getAttribute("data-jwplayer-id")))
                    : (e = v.a[0]),
                e)
            )
                return e;
